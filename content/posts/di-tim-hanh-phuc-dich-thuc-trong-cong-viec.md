...
Và đừng quên <a onclick="FB.ui({ method: 'feed', link: window.location.href })" class="pointer blue">chia sẻ</a> cho những người đang không được hài lòng trong công việc nhé.
