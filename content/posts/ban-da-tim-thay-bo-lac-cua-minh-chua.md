...
Cuối cùng, hãy <a onclick="FB.ui({ method: 'feed', link: window.location.href })" class="pointer blue underline">chia sẻ</a> bài viết để những người cũng đang tìm kiếm bộ lạc có thể liên hệ với bạn nhé :)
